...
- **Phase roadmap:** See `docs/flutter-pi-hmi-plan.md` §1 (P1–P2.5 done; next P3.0 CyberUI, **P3.1 Dart HAL**, P3.2 emulator, P3.3 AI, P4 business, P5.0 Android App/APK — not `cyber_hal` Android backends, P5.1 engine). HAL design: `openspec/changes/dart-hal-package/`. `cyber_hal` is Linux (+ stub) only.
