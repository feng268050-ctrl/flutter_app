...
P2 Flutter home demo: device-information rows (iSerial + Modbus), Alarm Information temperatures, mutually exclusive RGB LED mode controls, P2.1 Wi-Fi / HTTP proxy probe / Bluetooth discoverable sections, plus audio / brightness / orientation controls.
