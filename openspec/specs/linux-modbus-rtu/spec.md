# linux-modbus-rtu Specification

## Purpose

Linux Modbus RTU client for the HMI over `/dev/ttyS5`, matching the lws-ui register contract for device-info and Alarm Information temperature reads.
