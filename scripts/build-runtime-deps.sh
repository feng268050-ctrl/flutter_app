...
# Requires make lunch before flutter-engine / flutter-pi compile.
set -euo pipefail
...
echo "  prebuilt/: flutter-engine, flutter-pi, mediamtx, btop, rknn-rt, gstreamer/target, platform-packages/target"
