...
| `native/secrets_seal/**`, `scripts/build-secrets-seal.sh`, `prebuilt/secrets_seal/**`, overlay `usr/lib/optee_armtz/*.ta` / `secrets-seal-ca` | `make build-secrets-seal`, `make apply-overlay`, `make build-rootfs`, `make upgrade` |
