# advanced-settings-warn-severity Specification

## Purpose

Map dangerous-operations allow-* bypasses to warn dialog INFO vs WARN chrome (lws-ui `WarnDialogSeverity` parity).
## Requirements
