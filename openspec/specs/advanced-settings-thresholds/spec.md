# advanced-settings-thresholds Specification

## Purpose

Modbus-backed Advanced Settings numeric thresholds: watch/write catalogued attributes, App JSON cache, and lws-ui wire encoding.
## Requirements
