...
In Continuous Weld and Spot Weld screens, material display labels (including selector options and selected/current material text) SHALL be rendered from locale-specific resources and SHALL match the active app language.
...
- **WHEN** localization resources are updated for English material labels
