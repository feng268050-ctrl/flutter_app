# buildroot-gstreamer-security Specification

## Purpose
Product GStreamer/MPP stack pin, rebuild path, optional hardening, and residual-risk documentation for MediaMTX RTSP preview and HAL MP4 recording (Buildroot overlay + prebuilt export).
