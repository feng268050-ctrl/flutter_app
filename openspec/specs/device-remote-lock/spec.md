...
Server-initiated remote lock: persist lock state across reboots, block Fast/Engineer mode entry, eject active sessions, surface UI indicators, and expose lock status on the remote snapshot.
