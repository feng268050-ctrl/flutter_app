...
### Requirement: Common Settings uses Screen Settings icon resource
The Common Settings tab SHALL use the current Screen Settings icon artwork, and the resource name exposed to Settings navigation MUST be renamed to match Common Settings.

#### Scenario: Common Settings tab icon displays
- **WHEN** the user opens Settings
- **THEN** the Common Settings tab displays the icon artwork formerly used by Screen Settings
- **AND** the referenced resource name reflects Common Settings rather than Screen Settings
