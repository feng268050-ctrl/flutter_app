...
- **WHEN** multiple USB-SSH boards are connected and no serial is configured
- **THEN** the debug command fails with instructions to run `make devices` and set `SERIAL`
