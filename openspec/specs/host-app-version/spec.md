...
Host Make/scripts to print and bump per-APP Flutter `pubspec.yaml` version (+ optional `app_version.dart` sync) using a fixed 5-digit build encoding and overflow checks.
