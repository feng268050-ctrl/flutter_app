# buildroot-lts-baseline Specification

## Purpose
Product Buildroot baseline on upstream **2025.02.x LTS**, git-tracked tip pin for colleagues, clean output rebuild across major bumps, and LTS tip as the primary remediation unit (overlay package pins remain authoritative for OpenSSL/GStreamer/BlueZ/etc.).
