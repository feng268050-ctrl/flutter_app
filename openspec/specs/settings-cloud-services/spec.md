# settings-cloud-services Specification

## Purpose

Common Settings Network entry for optional cloud Worker connectivity and LAN HTTP/mDNS enhancement. Both planes default off and are operator-controlled.
