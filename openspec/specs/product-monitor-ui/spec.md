...
## Purpose
Product Monitor screen: Machine Status (live gauges/tiles), Alarm Information temperatures and active alarms via HAL attribute ids, and historical Alarm Logs (CyberUI chrome).
## Requirements
