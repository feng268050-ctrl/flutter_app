...
OVERLAY_LIB="$ROOT/overlay/board/rockchip/rk3566_rk3568/lws-hmi-fs-overlay/usr/lib/librknnrt.so"
OVERLAY_BIN="$ROOT/overlay/board/rockchip/rk3566_rk3568/lws-hmi-fs-overlay/usr/bin/rknn_server"
FORCE="${FORCE:-0}"
