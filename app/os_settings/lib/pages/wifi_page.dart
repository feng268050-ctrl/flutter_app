...
import 'package:os_settings/pages/wifi_details_page.dart';
...
class _WifiPageState extends State<WifiPage> {
  ...
  static String _wifiStatusConnecting(AppLocalizations l10n) => l10n.connectingLabel;
  ...
  Future<void> _connectSaved(String ssid) async {
    ...
    try {
      await showCyberBusyDialog<void>(
        context: context,
        title: _wifiStatusConnecting(AppLocalizations.of(context)!),
        work: () async {
      ...
      body: RefreshIndicator(
        ...
        child: SettingsScrollView(
          children: [
            ...
            if (_radioOn) ...[
              SettingsSectionHeader(l10n.myNetworks),
              SettingsGroup(
                borderGradientCenter:
              ...
              SettingsSectionHeader(l10n.otherNetworks),
              SettingsGroup(
              ...
              Padding(
                ...
                child: Center(
                  child: CyberButton(
                    ...
                    child: Text(l10n.wifiConnectHidden),
                  ),
                ),
              ),
            ],
