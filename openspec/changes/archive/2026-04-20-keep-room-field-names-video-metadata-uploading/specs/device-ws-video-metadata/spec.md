...
- **THEN** it MUST emit `video.metadata` whose JSON keys match the Java bean property names (camelCase), includes `videoId`, and does not include `id` or `videoPath`
