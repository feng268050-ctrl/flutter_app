# os-settings-app Specification

## Purpose
Independent Cyber OS Settings Flutter app (`app/os_settings` → `/opt/os_settings`): multi-card frost IA, copy/migrate/OS-only platform pages, Exit to HMI, no product gpio/modbus.
