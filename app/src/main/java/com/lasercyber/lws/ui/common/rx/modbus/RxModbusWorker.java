 ...
 * <p>
 * Rx observables do not apply {@code subscribeOn}; callers (e.g. {@link ModbusManagerRtu})
 * must schedule on the app serial Modbus executor so only one {@code subscribeOn} applies.
 */
public class RxModbusWorker extends ModbusWorker {
    private static final String TAG = LogTAGConstant.RxModbusWorker;
