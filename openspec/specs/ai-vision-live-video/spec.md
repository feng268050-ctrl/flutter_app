# ai-vision-live-video Specification

## Purpose
TBD - created by archiving change reduce-ai-vision-video-latency-glitches. Update Purpose after archive.
## Requirements
...
- **AND** SHALL use the same frame-sampling gate contract as production mode with `AiFrameSamplingInterval.AI_VISION_LIVE`
