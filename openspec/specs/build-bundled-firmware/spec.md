# build-bundled-firmware Specification

## Purpose

Bundle control-card firmware from the repository `firmware/` directory into APK assets at build time, sharing the same source of truth as `make pack`.
## Requirements
