# ai-vision-live-inference-overlay Specification

## Purpose

AI Vision live RTSP tab: OpenCV stain detect at 500 ms with client-side `DetectionOverlayView` hold-forward overlay (no on-frame compositor).
## Requirements
