...
# GStreamer 1.28 plugins without Rockchip Config.in entries — meson "auto"
# would otherwise ship unused surface (HIP/NVCODEC/MSE/CC/…). Product path
# only needs videoparsers + kms + sdp + faad from bad.
GST1_PLUGINS_BAD_CONF_OPTS += \
