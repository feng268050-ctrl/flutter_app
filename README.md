...
| P3.1 | Rust HAL / hald | 交叉编译 / overlay | Platform API；Demo 迁 HAL |
...
权威阶段表与旧号映射：[`docs/flutter-pi-hmi-plan.md` §1](docs/flutter-pi-hmi-plan.md)。HAL 设计：[`openspec/changes/rust-hal-and-phase-realign/`](openspec/changes/rust-hal-and-phase-realign/)。
