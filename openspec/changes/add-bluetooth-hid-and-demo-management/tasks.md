...
- [ ] 2.3 After connect on hardware, verify `/dev/input/event*` (or by-id) appears for the HID peripheral without changing USB HID behavior
...
- [ ] 5.4 Reject stale/unmatched agent requests; verify phone incoming pairing and A2DP Sink still work after agent changes
...
- [ ] 7.4 Coexistence: phone incoming pair/A2DP + HID bonds; bounded scan with Wi-Fi connected; USB keyboard/mouse unchanged
