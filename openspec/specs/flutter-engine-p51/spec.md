# flutter-engine-p51 Specification

## Purpose

Lockstep Flutter **3.41.x** host SDK + Buildroot/prebuilt **flutter-engine** + **flutter-embedded-linux** triplet for P5.1 (floor ≥ 3.41.0; shipped tip **3.41.9** / eLinux **42d3d75a56** unless a documented spike fallback applies). Covers prebuilt rebuild order, App/SDK analyze, device/debug acceptance, and roadmap status.
