...
OVERLAY_SO="$ROOT/overlay/board/rockchip/rk3566_rk3568/rootfs-overlay/usr/lib/libhmi_capture.so"
OVERLAY_HDR="$ROOT/overlay/board/rockchip/rk3566_rk3568/rootfs-overlay/usr/include/hmi_capture.h"
