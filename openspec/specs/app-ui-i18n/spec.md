# app-ui-i18n Specification

## Purpose

Flutter gen-l10n catalogs, host `make l10n*` workflow, and MaterialApp locale wiring for the HMI App (`en-US` / `zh-CN` / `zh-TW`), preferring lws-ui translations for implemented features.
## Requirements
