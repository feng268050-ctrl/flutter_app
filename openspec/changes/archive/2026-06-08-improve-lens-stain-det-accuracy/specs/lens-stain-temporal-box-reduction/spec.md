...
Production weld deferred L001 alerts MUST continue to ignore offline stain detect messages per existing `StainDetectAlertMapper.isOfflineStainDetectMessage` rules.
