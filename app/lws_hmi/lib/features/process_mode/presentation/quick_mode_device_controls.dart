            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _QuickSideToggle(
                          ...
                          // lws-ui: only continuous welding enables Auto Wire.
              ...
              Align(
                ...
                child: QuickModeLaserButton(
                  ...
                  onDisable: onDisable,
                  onBlocked: (message) {
                    // Key / E-stop / alarm tips already requested from
                    // [_laserPreflight] — do not also Toast.
                    if (message ==
...
final class _ManualWireButtonState extends State<_ManualWireButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      behavior: HitTestBehavior.opaque,
      onPointerDown: (_) {
        // Mode-incapable buttons are greyed (`enabled: false`); ignore quietly.
        if (!widget.enabled) {
          return;
        }
        if (widget.busy) {
      ...
      onPointerUp: (_) {
        if (!widget.enabled || widget.busy || widget.laserBlocked) {
          return;
        }
        _gesture.pointerUp();
        _syncBandBreath();
