...
/// Engineer-style value pill + frost anchored menu (settings Sound / Display).
///
/// Matches Quick/Engineer material picker chrome: pill trigger, transparent
/// barrier, [CyberCard] realtime frost list under the pill.
final class SettingsPillDropdown<T> extends StatelessWidget {
  ...
  /// Weld-tab orange — same selected accent as Engineer material popup default.
...
/// Anchored frost option list under a settings value pill.
