# camera-ping-health-check Specification

## Purpose

Probe configured camera IP reachability with lightweight ICMP ping for communication health (C002, Monitor tiles, stat snapshots) without periodic HTTP load on the IPC.
## Requirements
