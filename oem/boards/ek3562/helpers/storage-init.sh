#!/bin/sh
# ek3562 storage init (OEM). Panel timing: vendor DTS (pending).
# Mounts userdata/oem and binds prefs.
set -u
...
setup_by_name_links
mkdir -p /mnt/userdata /userdata /oem /dev/block/by-name
...
log "ek3562 storage-init done (panel DT pending)"
