# gstreamer-frame-extract Specification

## Purpose

Extract JPEG stills from local process-video MP4s using the product rootfs GStreamer stack (covers + AI Vision offline samples), without App-bundled ffmpeg.
