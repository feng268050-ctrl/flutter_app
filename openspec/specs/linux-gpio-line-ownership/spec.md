# linux-gpio-line-ownership Specification

## Purpose

Product GPIO pads are free for userspace gpiod after `gpio_innohi` cutover. Board enable lines stay kernel-owned via standard DT; indicators clear at halt without Innohi syscore.
