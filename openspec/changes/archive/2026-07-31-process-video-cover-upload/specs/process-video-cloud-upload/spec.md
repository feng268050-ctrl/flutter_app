...
2. Sets `uploadStatus == 2` and emits `video.uploading` progress
3. PutObjects the MP4
4. Sets `uploadStatus == 3` with `videoUrl`, emits final `video.uploading`, and keeps catalog fields consistent
