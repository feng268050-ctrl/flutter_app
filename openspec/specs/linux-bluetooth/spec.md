...
Linux Bluetooth for the HMI as a discoverable local adapter (phones/PCs find and connect to it), with optional A2DP Sink speaker path via BlueZ-ALSA. Central-role scanning of third-party accessories is out of scope.
