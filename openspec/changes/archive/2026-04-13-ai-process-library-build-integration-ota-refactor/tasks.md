...
- [x] 5.2 On device/emulator: confirm first launch imports from assets; bump bundled semver in a test build and confirm data updates; confirm OTA zip path still updates firmware/APK when manifest version bumps.
