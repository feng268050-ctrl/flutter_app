...
Product **OS Version** is stamped in rootfs `/etc/os-release` (Cyber OS) and exposed to HAL/App for Settings and whole-device OTA compare — independent of Flutter HMI Version.
