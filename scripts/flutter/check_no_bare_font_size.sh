...
SIZE_ALLOW_GLOBS=(
  ...
  --glob '!**/monitor/presentation/widgets/monitor_chrome.dart'
  --glob '!**/settings/presentation/widgets/settings_chrome.dart'
  --glob '!**/process_mode/presentation/engineer_mode_entry_tips_dialog.dart'
